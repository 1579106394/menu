...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/user/login.html" method=post>
                ...
                <TR>
                    <TD height=300>
                        <TABLE cellPadding=0 width=900 border=0>
                            <TBODY>
                            <TR align="center">
                                <TD colSpan=2 height=35><h2>登录页面</h2></TD>
                            </TR>
                            <TR>
                                <TD width=360></TD>
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            ...
                                            <TD>
                                                ...
                                                <INPUT type=button onclick="toRegister()" value="注册" name=btn>
                                            </TD>
                                        </TR>
                                        </TBODY>
                                    </TABLE>
